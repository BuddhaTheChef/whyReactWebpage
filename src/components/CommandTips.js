        ...
        return (
            <div>
               ...
               <div>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/aVPOoFic1i4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
              ...
              <div>
                <h1 style={{textAlign: 'center', marginTop: '80px', fontSize: '70px'}}>Command Tips</h1>
                <div className="gettingStartedVideoDiv">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/xa-_FIy2NgE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
